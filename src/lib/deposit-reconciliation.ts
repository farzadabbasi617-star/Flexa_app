...
import { inquirePayment, verifyPayment } from "@/lib/zarinpal";
    ...
    try {
      ...
      if (wallet) {
        ...
        await db.insert(notifications).values({
          ...
          message: `پرداخت ${amountLabel} تومانی شما تأیید و به کیف پول اضافه شد. شماره پیگیری: ${verification.refId}`,
          link: "/wallet",
        });
