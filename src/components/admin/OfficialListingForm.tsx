...
/**
 * Creates an official (Gament-owned) store listing.
 *
  ...
  return (
    <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-5">
      ...
      <p className="mb-4 text-[11px] leading-5 text-gray-500">
        این محصول با نام خود گیمنت ثبت می‌شود و <b className="text-gray-300">بدون نیاز به تأیید، فوراً فعال</b> است.
