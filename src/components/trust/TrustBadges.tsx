...
import ZarinpalMark from "@/components/trust/ZarinpalMark";
      ...
      <div className="relative">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-xs leading-7 text-gray-400 sm:text-sm sm:leading-8">
            گیمنت با مجوز رسمی نماد اعتماد الکترونیکی فعالیت می‌کند و تمام پرداخت‌ها از درگاه بانکی
            زرین‌پال انجام می‌شود. در خرید از فروشگاه، مبلغ تا لحظه‌ی تأیید تحویل نزد گیمنت
        ...
        <div className="mx-auto mt-9 grid max-w-3xl gap-4 sm:grid-cols-2">
          ...
          >
            ...
            />
            <div className="relative flex min-h-[132px] items-center justify-center" style={{ transform: "translateZ(38px)" }}>
              <ZarinpalMark className="h-[104px] w-[104px] drop-shadow-[0_14px_28px_rgba(234,179,8,.28)]" />
            </div>
            <h3 className="relative mt-5 text-sm font-black text-white">پرداخت امن زرین‌پال</h3>
            <p className="relative mt-2 text-[11px] leading-6 text-gray-500">
              تراکنش مستقیم روی درگاه بانکی. اطلاعات کارت شما هرگز وارد سایت گیمنت نمی‌شود.
            </p>
          </motion.div>
        </div>
