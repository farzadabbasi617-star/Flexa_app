...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  if (!page) return createPageMetadata({ title: "تورنومنت‌های گیمنت", description: "مسابقات آنلاین گیمنت", path: "/tournaments" });
          ...
          {open.length ? (
            ...
            <div className="gaming-card p-6 rounded-2xl border border-white/5 mb-4">
              <p className="text-sm text-gray-300 leading-8">
                همین حالا مسابقهٔ بازی خودت باز نیست، اما تورنومنت‌های گیمنت به‌صورت منظم برگزار می‌شوند و این صفحه به‌صورت خودکار به‌روز می‌ماند.
