    ...
    <>
      ...
      <div className="flex gap-2 mb-8 overflow-x-auto pb-3 snap-x scrollbar-hide" dir="rtl">
        {games.map((g) => (
          ...
          >
            <AppImage src={g.icon} alt={g.name} width={16} height={16} className="w-4 h-4 object-contain shrink-0" loading="lazy" decoding="async" />
            <span>{g.name}</span>
          </button>
        ))}
      </div>
              ...
              <Reveal as="section" key={gameId} className="relative" distance={22}>
                <div className="flex items-center justify-between gap-4 mb-5" dir="rtl">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="relative w-12 h-12 rounded-2xl bg-[#111114] border border-white/10 flex items-center justify-center p-2 sm:p-2.5 shadow-[0_0_20px_rgba(168,85,247,0.12)] shrink-0">
                      <AppImage src={meta.icon} alt={L(meta.fa, meta.en)} width={48} height={48} className="w-full h-full object-contain" loading="lazy" decoding="async" />
                    </div>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6" dir="rtl">
          <div className="text-right">
            <h1 className="text-2xl sm:text-3xl font-black flex items-center gap-2.5 justify-start">
              <AppImage src="/icons/honors_icon.png" alt="Tournaments" width={32} height={32} className="w-8 h-8 object-contain drop-shadow-[0_0_8px_#bc00ff] shrink-0" loading="lazy" decoding="async" />
