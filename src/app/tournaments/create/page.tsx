      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8 pb-28">
        ...
        <form onSubmit={handleSubmit} noValidate className="space-y-6">
          ...
          <div className="gaming-card p-5 border-neon-blue/20">
            ...
            {imageOptions.length > 0 ? (
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                {imageOptions.slice(0, 9).map((image) => (
                  ...
                  >
                    <AppImage src={image.url} alt={image.altText || image.title} fill className="object-cover" loading="lazy" decoding="async" />
            ...
            {form.bannerUrl && <div className="relative mt-4 h-36 w-full overflow-hidden rounded-2xl border border-white/10"><AppImage src={form.bannerUrl} alt="پیش‌نمایش" fill className="object-cover" loading="lazy" decoding="async" /></div>}
          </div>
