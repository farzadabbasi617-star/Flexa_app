                  ...
                  {availablePlayers.length === 0 ? (
                    ...
                    <div className="flex flex-col sm:flex-row gap-2">
                      {availablePlayers.length > 1 ? (
                        ...
                        <div className="flex-1 self-center rounded-xl bg-white/5 border border-white/10 px-3 py-2.5 text-xs text-gray-300">
                          ✅ ثبت‌نام با پروفایل خودت: <b className="text-white">{availablePlayers[0]?.displayName}</b>
                        </div>
                      )}
                      {isPaidTournament && walletBalance !== null && !hasEnoughWallet ? (
