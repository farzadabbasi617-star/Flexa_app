...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  if (!page) return createPageMetadata({ title: "فروشگاه گیمنت", description: "راهنمای خرید در گیمنت", path: "/store" });
      ...
      <main className="pb-28">
        ...
        <section className="max-w-5xl mx-auto px-4 sm:px-6 py-10" dir="rtl">
          <h2 className="text-xl font-black text-purple-300 mb-5">
            {listings.length ? "موجودی و قیمت‌های فعلی" : "خرید از فروشگاه گیمنت"}
          </h2>
          {listings.length ? (
