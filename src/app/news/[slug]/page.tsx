...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  if (!page) return createPageMetadata({ title: "اخبار گیمینگ", description: "اخبار بازی‌ها در گیمنت", path: "/honors" });
          ...
          {news.length ? (
            ...
            <div className="gaming-card p-6 rounded-2xl border border-white/5 mb-4">
              <p className="text-sm text-gray-300 leading-8">
                خبرهای این بازی به‌صورت خودکار توسط سیستم خبر گیمنت جمع‌آوری و ترجمه می‌شود و همین‌جا نمایش داده می‌شود.
